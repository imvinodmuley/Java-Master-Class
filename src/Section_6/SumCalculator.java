 ...
 * setFirstNumber with one parameter of type double, it needs to set the value
 * of the firstNumber field. Method named setSecondNumber with one parameter of
 * type double, it needs to set the value of the secondNumberfield. Method named
 ...
 * subtracting the field values of secondNumber from the firstNumber. Method
 * named getMultiplicationResult without any parameters, it needs to return the
