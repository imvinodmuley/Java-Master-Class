...
public class NumberToWords {
	...
	public static void numberToWords(int number)
	{
		...
		int unreversedNumber=reverse(number);
		//System.out.println(unreversedNumber);
		while(unreversedNumber!=0)
		{
			int temp =unreversedNumber%10;
			switch(temp)
			{
				case 0:
			...
			unreversedNumber=unreversedNumber/10;
		}
		
		if(getDigitCount(unreversedNumber)!=getDigitCount(number))
		{
			int difference=Math.abs(getDigitCount(reverse(number))-getDigitCount(number));
