 ...
 * the year is evenly divisible by 100, go to step 3. Otherwise, go to step 4.3.
 * If the year is evenly divisible by 400, go to step 4. Otherwise, go to step
 * 5.4. The year is a leap year (it has 366 days). The method isLeapYear needs
 * to return true. 5. The year is not a leap year (it has 365 days). The method
